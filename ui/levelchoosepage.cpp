...
void LevelChoosePage::init()
{
    ...
    this->setStyleSheet("QDialog { background-image: url(:/background/chooseLevelPage.png); }");
    ...
    for (int i = 0; i < totalLevels; ++i) {
        ...
        if (levelNum < unlockedLevel) {
            ...
            qss = QString(
                      "QPushButton {"
                      "    border: none;"
                      "    background-image: url(:/images/level_%1_normal.png);"
                      "}"
                      ).arg("");//levelNum);
        }
            ...
            qss = QString(
                      "QPushButton {"
                      "    border: none;"
                      "    background-image: url(:/images/level_%1_current.png);" // 或者是带红色呼吸灯效果的图
                      "}"
                      ).arg("");//levelNum);
        }
        else {
    ...
    backBtn->setStyleSheet("QPushButton { border: none; background-image: url(:/images/btn_back.png); }");
